...
#define __PYX_HAVE__pyndl__wh_parallel
#define __PYX_HAVE_API__pyndl__wh_parallel
/* Early includes */
#include <string.h>
#include <stdio.h>
 ...
 */
typedef __pyx_t_5numpy_float64_t __pyx_t_5pyndl_11wh_parallel_dtype_t;
/* Declarations.proto */
#if CYTHON_CCOMPLEX
  #ifdef __cplusplus
...
/* Module declarations from 'pyndl.wh_parallel' */
static unsigned int __pyx_v_5pyndl_11wh_parallel_MAGIC_NUMBER;
static unsigned int __pyx_v_5pyndl_11wh_parallel_CURRENT_VERSION_WITH_FREQ;
static unsigned int __pyx_v_5pyndl_11wh_parallel_CURRENT_VERSION;
static unsigned PY_LONG_LONG __pyx_v_5pyndl_11wh_parallel_test_index;
static unsigned int __pyx_v_5pyndl_11wh_parallel_test_cue_index;
static unsigned int __pyx_v_5pyndl_11wh_parallel_test_mm;
static unsigned int __pyx_v_5pyndl_11wh_parallel_test_outcome_index;
static CYTHON_INLINE void __pyx_f_5pyndl_11wh_parallel_read_next_int(void *, FILE *); /*proto*/
static int __pyx_f_5pyndl_11wh_parallel_learn_inplace_ptr(char *, __pyx_t_5pyndl_11wh_parallel_dtype_t *, __pyx_t_5pyndl_11wh_parallel_dtype_t, __pyx_t_5pyndl_11wh_parallel_dtype_t *, unsigned int, unsigned int, unsigned int *, unsigned int, unsigned int); /*proto*/
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_5pyndl_11wh_parallel_dtype_t = { "dtype_t", NULL, sizeof(__pyx_t_5pyndl_11wh_parallel_dtype_t), { 0 }, 0, 'R', 0, 0 };
...
#define __Pyx_MODULE_NAME "pyndl.wh_parallel"
extern int __pyx_module_is_main_pyndl__wh_parallel;
int __pyx_module_is_main_pyndl__wh_parallel = 0;

/* Implementation of 'pyndl.wh_parallel' */
...
static const char __pyx_k_outcome_vectors[] = "outcome_vectors";
...
static const char __pyx_k_pyndl_wh_parallel[] = "pyndl.wh_parallel";
static const char __pyx_k_cline_in_traceback[] = "cline_in_traceback";
static const char __pyx_k_length_all_outcomes[] = "length_all_outcomes";
static const char __pyx_k_n_vector_dimensions[] = "n_vector_dimensions";
static const char __pyx_k_outcome_vectors_ptr[] = "outcome_vectors_ptr";
static const char __pyx_k_filename_byte_string[] = "filename_byte_string";
static const char __pyx_k_pyndl_wh_parallel_pyx[] = "pyndl/wh_parallel.pyx";
...
static PyObject *__pyx_n_s_n_vector_dimensions;
...
static PyObject *__pyx_pf_5pyndl_11wh_parallel_learn_inplace(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_binary_file_paths, PyArrayObject *__pyx_v_outcome_vectors, __pyx_t_5pyndl_11wh_parallel_dtype_t __pyx_v_eta, PyArrayObject *__pyx_v_all_outcomes, PyArrayObject *__pyx_v_weights, unsigned int __pyx_v_chunksize, unsigned int __pyx_v_number_of_threads); /* proto */
...
static CYTHON_INLINE void __pyx_f_5pyndl_11wh_parallel_read_next_int(void *__pyx_v_data, FILE *__pyx_v_binary_file) {

  /* "pyndl/wh_parallel.pyx":31
 * 
 * cdef inline void read_next_int(void *data, FILE *binary_file) nogil:
 *     fread(data, 4, 1, binary_file) # little endian             # <<<<<<<<<<<<<<
 * 
...
/* Python wrapper */
static PyObject *__pyx_pw_5pyndl_11wh_parallel_1learn_inplace(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_5pyndl_11wh_parallel_1learn_inplace = {"learn_inplace", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_5pyndl_11wh_parallel_1learn_inplace, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_5pyndl_11wh_parallel_1learn_inplace(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyObject *__pyx_v_binary_file_paths = 0;
  PyArrayObject *__pyx_v_outcome_vectors = 0;
  __pyx_t_5pyndl_11wh_parallel_dtype_t __pyx_v_eta;
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_binary_file_paths,&__pyx_n_s_outcome_vectors,&__pyx_n_s_eta,&__pyx_n_s_all_outcomes,&__pyx_n_s_weights,&__pyx_n_s_chunksize,&__pyx_n_s_number_of_threads,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_outcome_vectors)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("learn_inplace", 1, 7, 7, 1); __PYX_ERR(0, 43, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_eta)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("learn_inplace", 1, 7, 7, 2); __PYX_ERR(0, 43, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_all_outcomes)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("learn_inplace", 1, 7, 7, 3); __PYX_ERR(0, 43, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_weights)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("learn_inplace", 1, 7, 7, 4); __PYX_ERR(0, 43, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_chunksize)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("learn_inplace", 1, 7, 7, 5); __PYX_ERR(0, 43, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  6:
        if (likely((values[6] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_number_of_threads)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("learn_inplace", 1, 7, 7, 6); __PYX_ERR(0, 43, __pyx_L3_error)
        }
      }
    ...
    __pyx_v_outcome_vectors = ((PyArrayObject *)values[1]);
    __pyx_v_eta = __pyx_PyFloat_AsDouble(values[2]); if (unlikely((__pyx_v_eta == ((npy_float64)-1)) && PyErr_Occurred())) __PYX_ERR(0, 45, __pyx_L3_error)
    __pyx_v_all_outcomes = ((PyArrayObject *)values[3]);
    __pyx_v_weights = ((PyArrayObject *)values[4]);
    __pyx_v_chunksize = __Pyx_PyInt_As_unsigned_int(values[5]); if (unlikely((__pyx_v_chunksize == (unsigned int)-1) && PyErr_Occurred())) __PYX_ERR(0, 48, __pyx_L3_error)
    __pyx_v_number_of_threads = __Pyx_PyInt_As_unsigned_int(values[6]); if (unlikely((__pyx_v_number_of_threads == (unsigned int)-1) && PyErr_Occurred())) __PYX_ERR(0, 49, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("learn_inplace", 1, 7, 7, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 43, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("pyndl.wh_parallel.learn_inplace", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_outcome_vectors), __pyx_ptype_5numpy_ndarray, 1, "outcome_vectors", 0))) __PYX_ERR(0, 44, __pyx_L1_error)
  ...
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_weights), __pyx_ptype_5numpy_ndarray, 1, "weights", 0))) __PYX_ERR(0, 47, __pyx_L1_error)
  __pyx_r = __pyx_pf_5pyndl_11wh_parallel_learn_inplace(__pyx_self, __pyx_v_binary_file_paths, __pyx_v_outcome_vectors, __pyx_v_eta, __pyx_v_all_outcomes, __pyx_v_weights, __pyx_v_chunksize, __pyx_v_number_of_threads);
...
static PyObject *__pyx_pf_5pyndl_11wh_parallel_learn_inplace(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_binary_file_paths, PyArrayObject *__pyx_v_outcome_vectors, __pyx_t_5pyndl_11wh_parallel_dtype_t __pyx_v_eta, PyArrayObject *__pyx_v_all_outcomes, PyArrayObject *__pyx_v_weights, unsigned int __pyx_v_chunksize, unsigned int __pyx_v_number_of_threads) {
  unsigned int __pyx_v_mm;
  unsigned int *__pyx_v_all_outcomes_ptr;
  CYTHON_UNUSED unsigned int __pyx_v_length_all_outcomes;
  unsigned int __pyx_v_n_vector_dimensions;
  char *__pyx_v_fname;
  ...
  __Pyx_LocalBuf_ND __pyx_pybuffernd_outcome_vectors;
  __Pyx_Buffer __pyx_pybuffer_outcome_vectors;
  ...
  __pyx_pybuffernd_outcome_vectors.data = NULL;
  __pyx_pybuffernd_outcome_vectors.rcbuffer = &__pyx_pybuffer_outcome_vectors;
  ...
  __pyx_pybuffernd_weights.rcbuffer = &__pyx_pybuffer_weights;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_outcome_vectors.rcbuffer->pybuffer, (PyObject*)__pyx_v_outcome_vectors, &__Pyx_TypeInfo_nn___pyx_t_5pyndl_11wh_parallel_dtype_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 43, __pyx_L1_error)
  }
  __pyx_pybuffernd_outcome_vectors.diminfo[0].strides = __pyx_pybuffernd_outcome_vectors.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_outcome_vectors.diminfo[0].shape = __pyx_pybuffernd_outcome_vectors.rcbuffer->pybuffer.shape[0]; __pyx_pybuffernd_outcome_vectors.diminfo[1].strides = __pyx_pybuffernd_outcome_vectors.rcbuffer->pybuffer.strides[1]; __pyx_pybuffernd_outcome_vectors.diminfo[1].shape = __pyx_pybuffernd_outcome_vectors.rcbuffer->pybuffer.shape[1];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_weights.rcbuffer->pybuffer, (PyObject*)__pyx_v_weights, &__Pyx_TypeInfo_nn___pyx_t_5pyndl_11wh_parallel_dtype_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 43, __pyx_L1_error)
  }
 ...
 */
  __pyx_v_n_vector_dimensions = (__pyx_v_outcome_vectors->dimensions[1]);

  /* "pyndl/wh_parallel.pyx":57
 *     cdef char* fname
 *     cdef unsigned int start_val, end_val, ii, number_parts
 *     cdef int error = 4             # <<<<<<<<<<<<<<
 * 
 ...
 * 
 */
  __pyx_v_weights_ptr = ((__pyx_t_5pyndl_11wh_parallel_dtype_t *)__pyx_v_weights->data);

  /* "pyndl/wh_parallel.pyx":63
 *     #cdef np.ndarray[np.uint32_t, ndim=3, mode = 'c'] np_buff = np.ascontiguousarray(im, dtype = np.uint32)
 *     cdef dtype_t* weights_ptr = <dtype_t *> weights.data # ueberlegen ob [][] oder ** oder [] oder *
 *     cdef dtype_t* outcome_vectors_ptr = <dtype_t *> outcome_vectors.data # ueberlegen ob [][] oder ** oder [] oder *             # <<<<<<<<<<<<<<
 * 
 * 
 */
  __pyx_v_outcome_vectors_ptr = ((__pyx_t_5pyndl_11wh_parallel_dtype_t *)__pyx_v_outcome_vectors->data);

  /* "pyndl/wh_parallel.pyx":66
 * 
 * 
 ...
 */
  if (likely(PyList_CheckExact(__pyx_v_binary_file_paths)) || PyTuple_CheckExact(__pyx_v_binary_file_paths)) {
    ...
    __pyx_t_2 = -1; __pyx_t_1 = PyObject_GetIter(__pyx_v_binary_file_paths); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 66, __pyx_L1_error)
 ...
 */
  ...
  { PyObject *__pyx_type, *__pyx_value, *__pyx_tb;
    ...
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_outcome_vectors.rcbuffer->pybuffer);
...
static int __pyx_f_5pyndl_11wh_parallel_learn_inplace_ptr(char *__pyx_v_binary_file_path, __pyx_t_5pyndl_11wh_parallel_dtype_t *__pyx_v_outcome_vectors, __pyx_t_5pyndl_11wh_parallel_dtype_t __pyx_v_eta, __pyx_t_5pyndl_11wh_parallel_dtype_t *__pyx_v_weights, unsigned int __pyx_v_mm, unsigned int __pyx_v_n_vector_dimensions, unsigned int *__pyx_v_all_outcome_indices, unsigned int __pyx_v_start, unsigned int __pyx_v_end) {
  unsigned int __pyx_v_number_of_events;
  unsigned int __pyx_v_number_of_cues;
  unsigned int __pyx_v_number_of_outcomes;
  __pyx_t_5pyndl_11wh_parallel_dtype_t __pyx_v_association_strength;
  __pyx_t_5pyndl_11wh_parallel_dtype_t __pyx_v_update;
 ...
 *         fclose(binary_file)
 */
  __pyx_f_5pyndl_11wh_parallel_read_next_int((&__pyx_v_magic_number), __pyx_v_binary_file);

  /* "pyndl/wh_parallel.pyx":144
 * 
 *     read_next_int(&magic_number, binary_file)
 *     if not magic_number == MAGIC_NUMBER:             # <<<<<<<<<<<<<<
 *         fclose(binary_file)
 *         return 1
 */
  __pyx_t_1 = ((!((__pyx_v_magic_number == __pyx_v_5pyndl_11wh_parallel_MAGIC_NUMBER) != 0)) != 0);
  if (__pyx_t_1) {

    /* "pyndl/wh_parallel.pyx":145
 *     read_next_int(&magic_number, binary_file)
 *     if not magic_number == MAGIC_NUMBER:
 *         fclose(binary_file)             # <<<<<<<<<<<<<<
 *         return 1
 ...
 *         pass
 */
  __pyx_f_5pyndl_11wh_parallel_read_next_int((&__pyx_v_version), __pyx_v_binary_file);

  /* "pyndl/wh_parallel.pyx":148
 *         return 1
 *     read_next_int(&version, binary_file)
 *     if version == CURRENT_VERSION:             # <<<<<<<<<<<<<<
 *         pass
 *     else:
 */
  __pyx_t_1 = ((__pyx_v_version == __pyx_v_5pyndl_11wh_parallel_CURRENT_VERSION) != 0);
  if (__pyx_t_1) {
    goto __pyx_L4;
  }

  /* "pyndl/wh_parallel.pyx":151
 *         pass
 *     else:
 *         fclose(binary_file)             # <<<<<<<<<<<<<<
 *         return 2
 ...
 */
  __pyx_f_5pyndl_11wh_parallel_read_next_int((&__pyx_v_number_of_events), __pyx_v_binary_file);

  /* "pyndl/wh_parallel.pyx":160
 *     read_next_int(&number_of_events, binary_file)
 * 
 *     for event in range(number_of_events):             # <<<<<<<<<<<<<<
 *         # cues
 ...
 */
    __pyx_f_5pyndl_11wh_parallel_read_next_int((&__pyx_v_number_of_cues), __pyx_v_binary_file);

    /* "pyndl/wh_parallel.pyx":163
 *         # cues
 *         read_next_int(&number_of_cues, binary_file)
 *         if number_of_cues > max_number_of_cues:             # <<<<<<<<<<<<<<
 *             max_number_of_cues = number_of_cues
 ...
 *             fclose(binary_file)
 */
    __pyx_f_5pyndl_11wh_parallel_read_next_int((&__pyx_v_number_of_outcomes), __pyx_v_binary_file);

    /* "pyndl/wh_parallel.pyx":171
 *         # outcomes
 *         read_next_int(&number_of_outcomes, binary_file)
 *         if number_of_outcomes != 1:             # <<<<<<<<<<<<<<
 *             fclose(binary_file)
 *             return 7
 */
    __pyx_t_1 = ((__pyx_v_number_of_outcomes != 1) != 0);
    if (__pyx_t_1) {

      /* "pyndl/wh_parallel.pyx":172
 *         read_next_int(&number_of_outcomes, binary_file)
 *         if number_of_outcomes != 1:
 *             fclose(binary_file)             # <<<<<<<<<<<<<<
 *             return 7
 ...
 */
        __pyx_v_index = (__pyx_v_index * __pyx_v_ii);

        /* "pyndl/wh_parallel.pyx":189
 *                 index = mm  # implicit cast to unsigned long long
 *                 index *=  ii  # this can't overflow anymore
 *                 index += cue_indices[jj]  # this can't overflow anymore             # <<<<<<<<<<<<<<
 *                 # worst case: 4294967295 * 4294967295 + 4294967295 == 18446744069414584320 < 18446744073709551615
 ...
 *             index += ii
 */
      __pyx_v_index = __pyx_v_n_vector_dimensions;

      /* "pyndl/wh_parallel.pyx":193
 *                 association_strength += weights[index]
 *             index = n_vector_dimensions
 *             index *= all_outcome_indices[outcome_indices[0]]             # <<<<<<<<<<<<<<
 *             index += ii
 ...
 */
      __pyx_v_index = (__pyx_v_index * (__pyx_v_all_outcome_indices[(__pyx_v_outcome_indices[0])]));

      /* "pyndl/wh_parallel.pyx":194
 *             index = n_vector_dimensions
 *             index *= all_outcome_indices[outcome_indices[0]]
 *             index += ii             # <<<<<<<<<<<<<<
 *             update = eta * (outcome_vectors[index] - association_strength)
 ...
 *               index = mm  # implicit cast to unsigned long long
 */
      __pyx_v_update = (__pyx_v_eta * ((__pyx_v_outcome_vectors[__pyx_v_index]) - __pyx_v_association_strength));

      /* "pyndl/wh_parallel.pyx":196
 *             index += ii
 *             update = eta * (outcome_vectors[index] - association_strength)
 *             for jj in range(number_of_cues):             # <<<<<<<<<<<<<<
 *               index = mm  # implicit cast to unsigned long long
 ...
 */
        ...
        (__pyx_v_weights[__pyx_t_11]) = ((__pyx_v_weights[__pyx_t_11]) + __pyx_v_update);
      }
    }
  }

  /* "pyndl/wh_parallel.pyx":202
 *               weights[index] += update
 * 
 *     fclose(binary_file)             # <<<<<<<<<<<<<<
 *     free(cue_indices)
...
static int __pyx_pymod_exec_wh_parallel(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_wh_parallel},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_n_vector_dimensions, __pyx_k_n_vector_dimensions, sizeof(__pyx_k_n_vector_dimensions), 0, 0, 1, 1},
 ...
 *                   dtype_t eta,
 */
  __pyx_tuple__8 = PyTuple_Pack(21, __pyx_n_s_binary_file_paths, __pyx_n_s_outcome_vectors, __pyx_n_s_eta, __pyx_n_s_all_outcomes, __pyx_n_s_weights, __pyx_n_s_chunksize, __pyx_n_s_number_of_threads, __pyx_n_s_mm, __pyx_n_s_all_outcomes_ptr, __pyx_n_s_length_all_outcomes, __pyx_n_s_n_vector_dimensions, __pyx_n_s_fname, __pyx_n_s_start_val, __pyx_n_s_end_val, __pyx_n_s_ii, __pyx_n_s_number_parts, __pyx_n_s_error, __pyx_n_s_weights_ptr, __pyx_n_s_outcome_vectors_ptr, __pyx_n_s_binary_file_path, __pyx_n_s_filename_byte_string); if (unlikely(!__pyx_tuple__8)) __PYX_ERR(0, 43, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__8);
  __Pyx_GIVEREF(__pyx_tuple__8);
  __pyx_codeobj__9 = (PyObject*)__Pyx_PyCode_New(7, 0, 21, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__8, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_pyndl_wh_parallel_pyx, __pyx_n_s_learn_inplace, 43, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__9)) __PYX_ERR(0, 43, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initwh_parallel(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initwh_parallel(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_wh_parallel(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_wh_parallel(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_wh_parallel(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'wh_parallel' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_wh_parallel(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("wh_parallel", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_pyndl__wh_parallel) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "pyndl.wh_parallel")) {
      if (unlikely(PyDict_SetItemString(modules, "pyndl.wh_parallel", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  __pyx_v_5pyndl_11wh_parallel_MAGIC_NUMBER = 0xD80DA1;

  /* "pyndl/wh_parallel.pyx":10
 * 
 * cdef unsigned int MAGIC_NUMBER = 14159265
 * cdef unsigned int CURRENT_VERSION_WITH_FREQ = 215             # <<<<<<<<<<<<<<
 * cdef unsigned int CURRENT_VERSION = 2048 + 215
 * 
 */
  __pyx_v_5pyndl_11wh_parallel_CURRENT_VERSION_WITH_FREQ = 0xD7;

  /* "pyndl/wh_parallel.pyx":11
 * cdef unsigned int MAGIC_NUMBER = 14159265
 * cdef unsigned int CURRENT_VERSION_WITH_FREQ = 215
 * cdef unsigned int CURRENT_VERSION = 2048 + 215             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_v_5pyndl_11wh_parallel_CURRENT_VERSION = 0x8D7;

  /* "pyndl/wh_parallel.pyx":15
 * # run two sanity checks while loading the extension
 * # 1. check
 ...
 * test_index = test_mm
 */
  __pyx_v_5pyndl_11wh_parallel_test_cue_index = 0xFFFFFFFF;
  __pyx_v_5pyndl_11wh_parallel_test_mm = 0xFFFFFFFF;
  __pyx_v_5pyndl_11wh_parallel_test_outcome_index = 0xFFFFFFFF;

  /* "pyndl/wh_parallel.pyx":24
 * test_cue_index = test_mm = test_outcome_index = 4294967295
 * 
 * test_index = test_mm             # <<<<<<<<<<<<<<
 ...
 */
  __pyx_v_5pyndl_11wh_parallel_test_index = __pyx_v_5pyndl_11wh_parallel_test_mm;

  /* "pyndl/wh_parallel.pyx":25
 * 
 * test_index = test_mm
 * test_index *= test_outcome_index             # <<<<<<<<<<<<<<
 * test_index += test_cue_index
 ...
 */
  __pyx_v_5pyndl_11wh_parallel_test_index = (__pyx_v_5pyndl_11wh_parallel_test_index * __pyx_v_5pyndl_11wh_parallel_test_outcome_index);

  /* "pyndl/wh_parallel.pyx":26
 * test_index = test_mm
 * test_index *= test_outcome_index
 * test_index += test_cue_index             # <<<<<<<<<<<<<<
 * assert test_index == 18446744069414584320
 * 
 */
  __pyx_v_5pyndl_11wh_parallel_test_index = (__pyx_v_5pyndl_11wh_parallel_test_index + __pyx_v_5pyndl_11wh_parallel_test_cue_index);

  /* "pyndl/wh_parallel.pyx":27
 * test_index *= test_outcome_index
 * test_index += test_cue_index
 * assert test_index == 18446744069414584320             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  if (unlikely(!Py_OptimizeFlag)) {
    __pyx_t_1 = __Pyx_PyInt_From_unsigned_PY_LONG_LONG(__pyx_v_5pyndl_11wh_parallel_test_index); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 27, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
 ...
 *                   dtype_t eta,
 */
  __pyx_t_3 = PyCFunction_NewEx(&__pyx_mdef_5pyndl_11wh_parallel_1learn_inplace, NULL, __pyx_n_s_pyndl_wh_parallel); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 43, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init pyndl.wh_parallel", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init pyndl.wh_parallel");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
